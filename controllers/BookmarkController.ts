 ...
 export default class BookmarkController implements BookmarkControllerI {
     ...
     public static getInstance = (app: Express): BookmarkController => {
         if(BookmarkController.bookmarkController === null) {
             ...
             app.delete("/api/users/:uid/unbookmarks", BookmarkController.bookmarkController.userUnBookmarksAllTuit);
         }
     ...
     /**
      * @param {Request} req Represents request from client, including the
      * path parameter ui representing the user that is unbookmarking
      * the tuits
      * @param {Response} res Represents response to client, including status
      * on whether deleting the bookmarks was successful or not
      */
